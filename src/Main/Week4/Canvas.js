...
function getRandomColorPair() {
    const colorPairs = [
        ['rgba(78,46,56,1)', 'rgba(78,46,56,1)'],
        ['rgba(255,199,150,1)', 'rgba(255,199,150,1)'],
        ['rgba(255,126,180,1)', 'rgba(255,126,180,1)'],
        ['rgba(212,181,98,1)', 'rgba(212,181,98,1)'],
        ['rgba(201,45,53,1)', 'rgba(201,45,53,1)']
    ]
